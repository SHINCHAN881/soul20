...
bot = telebot.TeleBot('7314170762:AAFRciOeqdIJjKenWS0z0tc98AgHWqDnnCE')

# Admin user IDs
admin_id = {"6787450988", "12345667", "12345667"}
...
def handle_soul(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @topclix ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ Tyagi family ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
